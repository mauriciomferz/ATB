...
eyJhbGciOiJFZERTQSIsImtpZCI6IjxrZXktaWQ+IiwidHlwIjoiSldUIn0.<header>.<signature>

> **Note:** This is a placeholder format. Real tokens contain base64-encoded claims.
Decoded payload:
...
curl -X GET http://broker:8080/api/contacts/12345 \
